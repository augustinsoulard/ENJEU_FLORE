...
BDC_STATUTS_17_FLORE = BDC_STATUTS_17_FLORE %>%
  filter(LB_STATUT_COL %in% 
           c("Convention.de.Barcelone_France.métropolitaine", "Convention.de.Berne_France.métropolitaine", 
             ...
             "Liste.rouge.régionale_Rhône.Alpes","Liste.rouge.régionale_Auvergne", "Lutte.contre.certaines.espèces_France.métropolitaine", 
...
TAXREFv17_FLORE_JOIN = TAXREFv17_FLORE_JOIN %>% select(CD_NOM = CD_REF,
                                ...
                                LRR_RA = Liste.rouge.régionale_Rhône.Alpes, 
                                LRR_Au = Liste.rouge.régionale_Auvergne,
                                # SCAP.régionale_Rhône.Alpes et SCAP.régionale_Auvergne
